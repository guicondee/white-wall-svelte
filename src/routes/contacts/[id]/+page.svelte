<script lang="ts">
    import ArrowLeftThinCircleOutline from "svelte-material-icons/ArrowLeftThinCircleOutline.svelte";
...
<div class="container px-2 lg:mx-auto lg:w-full flex lg:justify-center lg:py-8">
    <div class="h-full">
        <div class="">
            <a class="" href="/">
                <ArrowLeftThinCircleOutline width={26} height={26} color="#6b7280" />
            </a>
        </div>
